...
export function ResumePreview({ profile, data }: ResumePreviewProps) {
  return (
    <div className="fixed top-0 right-0 h-screen flex flex-col bg-background" style={{ width: '50vw' }}>
      ...
      <div className="overflow-y-auto hide-scrollbar p-6" style={{ height: 'calc(100vh - 73px)', marginTop: '73px' }}>
        <div className="bg-card dark:bg-card shadow-lg border border-border p-8 max-w-[8.5in] mx-auto min-h-[11in] rounded-lg">
